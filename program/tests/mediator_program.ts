...
import { MediatorProgram } from "../target/types/mediator_program";
import {
...
describe("mediator_program", () => {
  ...
  const program = anchor.workspace.MediatorProgram as Program<MediatorProgram>;
